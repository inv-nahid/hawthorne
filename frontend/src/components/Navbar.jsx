  ...
  return (
    <nav className="absolute top-0 left-0 w-full py-4 px-10 bg-transparent text-white flex justify-between items-center z-50">
      ...
      <Link to="/" className="flex gap-2 items-center">
        ...
        />
        <span className="text-lg font-medium">HWT</span>
      </Link>

      {/* Desktop Menu */}
      <div className="hidden md:flex gap-5 items-center">
        <Link to="/about" className="font-medium hover:text-red-700">
          About
        </Link>
        <Link to="/contact" className="font-medium hover:text-red-700">
          Contact
        </Link>
        <Link to="/menu" className="font-medium hover:text-red-700">
          Menu
        </Link>
      </div>
      ...
      {/* Mobile Hamburger / Cross with smooth transition */}
      <button
        className="p-2 md:hidden z-50 relative w-8 h-8 flex flex-col justify-between items-center"
        onClick={handleMenu}
      >
        <div
